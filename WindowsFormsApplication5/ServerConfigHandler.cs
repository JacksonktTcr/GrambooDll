...
public class  ServerProperties : ConfigurationElement
{
    ...
    public string DbAServerName
		...
		[ConfigurationProperty("DbLAPassword", DefaultValue = @"P@SSW0RD", IsRequired = true)]
		public string DbLAPassword
		{
			get
			{
				return (string)this["DbLAPassword"];
			}
			set
			{
				this["DbLAPassword"] = value;
			}
		}
